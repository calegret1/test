...
## https://www.odoo.com/documentation/16.0/setup/install.html#debian-ubuntu
  ...
  sudo wget http://mirrors.kernel.org/ubuntu/pool/universe/w/wkhtmltopdf/wkhtmltopdf_0.12.6-2_amd64.deb
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    #cristian sudo pip3 install psycopg2-binary pdfminer.six
    echo -e "\n============ Create symlink for node ==============="
    sudo ln -s /usr/bin/nodejs /usr/bin/node
    sudo su $OE_USER -c "mkdir $OE_HOME/enterprise"
    sudo su $OE_USER -c "mkdir $OE_HOME/enterprise/addons"

    GITHUB_RESPONSE=$(sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/calegret1/enterprise "$OE_HOME/enterprise/addons" 2>&1)
   ...
   #cristian sudo -H pip3 install num2words ofxparse dbfread ebaysdk firebase_admin pyOpenSSL
   #cristian sudo npm install -g less-plugin-clean-css
fi
